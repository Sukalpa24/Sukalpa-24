...
const data = [
  { 
      ...
      Rules : [
        ...
        "Round Two: Reverse Coding -> You will be given the output and a suitable input without any description. You need to deduce the logic and code it.",
          ...
          id: 5,
           title: "ENGINEERS EYE",
            ...
            Rules : [
                ...
                "Level-1: Logo lookup",
                "Level-2: Who am I? -> Identify the technology, personality, Audio ",
                "Level-3: EYE SPY ",
            ...
            form : "",
           },
             {
               ...
               Rules : [
                ...
                "Team must be ready when called for match and no type of delaye will be caused.",
                ...
                "Device will be must be your  and can be played from home",
               ],
              Coordinator1: "DEEPAK",
